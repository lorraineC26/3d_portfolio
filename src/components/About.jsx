...
const About = () => {
  return (
    <>
      ...
      >
        My coding journey began in my final summer at McGill while studying
        Nutrition. A course called 'Programming in Life Science' introduced me
        to Python, where I used it to analyze patient weight control data and
        ...
        alongside my technical abilities in TypeScript, React, NextJS, and more.
        I have a knack for breaking down complex concepts into simple terms, and
        I'm excited to build solutions that make a real impact.
        <br />
        <br />
        <a
